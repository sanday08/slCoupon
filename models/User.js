...
const UserSchema = new mongoose.Schema({
  ...
  role: {
    type: String,
    enum: ["retailer", "distributer","superDisributer","Admin"], //if you write admin than its display error "`admin` is not a valid enum value for path `role`".
    default: "retailer",
  },
  userName:{
    type: Number,
...
UserSchema.methods.getSignedJwtToken = function () {
  return jwt.sign({ id: this._id,role:this.role, userName:this.userName, creditPoint:this.creditPoint,name:this.name }, process.env.JWT_SECRET, {
